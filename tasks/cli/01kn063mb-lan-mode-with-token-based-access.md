...
- [ ] Print the full access URL with token to the terminal on startup (e.g. `http://192.168.0.8:4880?token=abc123`)
...
- The access URL with token is printed to stdout on startup
